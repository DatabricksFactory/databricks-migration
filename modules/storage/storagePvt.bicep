    ...
    privateLinkServiceConnections: [
      {
        name: privateEndpointNamestorage
        properties: {
          privateLinkServiceId: blobAccountPrivate.id
          groupIds: [
