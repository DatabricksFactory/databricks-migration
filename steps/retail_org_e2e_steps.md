...
2. Download the "dim_fact_PBI_report_query.pbix" file from the [this location](https://github.com/DatabricksFactory/databricks-migration/blob/dev/docs/dim_fact_PBI_report_query.pbix)
